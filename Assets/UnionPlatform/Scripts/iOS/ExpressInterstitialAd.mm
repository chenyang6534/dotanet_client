...
extern "C" {
    ...
    void UnionPlatform_ExpressInterstitialsAd_Load(
        ...
        instance.interstitialAd = [[BUNativeExpressInterstitialAd alloc] initWithSlotID:[[NSString alloc] initWithUTF8String:slotID] adSize:CGSizeMake(width,height)];
    ...
    void UnionPlatform_ExpressInterstitialAd_Dispose(void* expressAdPtr) {
        ExpressInterstitialAd *expressAd = (__bridge_transfer ExpressInterstitialAd*)expressAdPtr;
