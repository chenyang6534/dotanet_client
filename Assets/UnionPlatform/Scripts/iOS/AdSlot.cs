...
namespace ByteDance.Union
{
    ...
    public sealed class AdSlot
    {
        ...
        /// </summary>
        internal string RewardName { get; set; }

        /// <summary>
        /// Gets or sets the reward amount.
        /// </summary>
        internal int RewardAmount { get; set; }
        ...
        public class Builder
        {
            ...
            {
                this.slot.RewardName = rewardName;
                return this;
            }

            /// <summary>
            /// Sets the extra reward name for Ad.
            /// </summary>
            public Builder SetRewardAmount(int rewardAmount)
            {
                this.slot.RewardAmount = rewardAmount;
                return this;
            }

            /// <summary>
            /// Sets the extra reward amount for Ad.
            /// </summary>
            public Builder SetMediaExtra(string extra)
            {
                this.slot.ExtraInfo = extra;
                return this;
            }
