...
@interface LGToUnityExpressAdManager : NSObject<BUNativeExpressAdViewDelegate, UITableViewDelegate, UITableViewDataSource>
...
- (void)refreshAds:(NSInteger)loadCount {
    [self.expressAdManager loadAd:loadCount];
}
...
extern "C" {
    ...
    void UnionPlatform_ExpressAd_Load(
        ...
        [instance.expressAdManager loadAd:adCount];
    ...
    void UnionPlatform_ExpressAdView_Dispose(void* expressAdViewPtr) {
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            BUNativeExpressAdView *expressAdView = (__bridge_transfer BUNativeExpressAdView*)expressAdViewPtr;
            [[BUToUnityAdManager sharedInstance] deleteAdManager:expressAdView];
        });
    }
